      ...
      <div className="bg-white/10 backdrop-blur-md p-6 md:p-8 rounded-2xl shadow-[0_8px_32px_0_rgba(0,0,0,0.36)] border border-white/20 w-full animate-fade-in-up">
         ...
         <form onSubmit={handleSubmit} className="flex flex-col md:flex-row gap-4 items-center">
            <input 
              type="text" 
              required 
              className="w-full md:w-1/4 px-4 py-3 bg-black/40 border border-white/10 text-white placeholder-gray-400 rounded-lg focus:ring-2 focus:ring-pop-orange focus:border-transparent outline-none transition-all hover:bg-black/50"
            ...
            <select 
              defaultValue=""
              className="w-full md:w-1/4 px-4 py-3 bg-black/40 border border-white/10 text-white placeholder-gray-400 rounded-lg focus:ring-2 focus:ring-pop-orange focus:border-transparent outline-none transition-all hover:bg-black/50 [&>option]:text-black"
            >
            ...
            <div className="w-full md:w-1/4">
              <Button type="submit" fullWidth disabled={loading} className="py-3 shadow-xl">
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        <div>
          ...
          <input 
            ...
            id="name" 
            required 
            className="w-full px-4 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-pop-orange focus:border-transparent outline-none"
