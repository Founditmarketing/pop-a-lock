...
export const CommercialLockoutPage: React.FC = () => {
  const service = SERVICES.find(s => s.id === 'commercial-lockout');
  if (!service) return null;

  return (
    <div className="bg-white">
      <PageSEO
        title="Commercial Lockout Service | Pop-A-Lock of Alexandria, LA"
        description="Locked out of your business in Alexandria, LA? Fast office, file cabinet, and commercial lockout service with master key systems available."
        path="/services/commercial-lockout"
        jsonLd={[LOCAL_BUSINESS_SCHEMA, buildServiceSchema(service, '/services/commercial-lockout')]}
      />
      {/* 1. Page Hero Section */}
